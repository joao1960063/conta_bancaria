    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // CONTA
                        .requestMatchers(HttpMethod.GET, "/contas").hasRole("GERENTE","CLIENTE")
                        .requestMatchers(HttpMethod.POST, "/contas").hasRole("GERENTE","CLIENTE")
                        .requestMatchers(HttpMethod.PUT, "/contas").hasRole("GERENTE","CLIENTE")
                        .requestMatchers(HttpMethod.DELETE, "/contas").hasRole("GERENTE","CLIENTE")
